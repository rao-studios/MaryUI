...
LP_TEST(settings_keep_their_defaults_and_bounds) {
    ...
    LP_ASSERT(fresh.mary_recall_personal && fresh.mary_recall_behavioral);
    char path[700];
    ...
    LP_ASSERT(!s.mary_recall_behavioral && s.mary_recall_personal);
