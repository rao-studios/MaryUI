/* Desktop preferences (web/src/desktop/settings.ts): accent, goo, wallpaper
 * source, reduced motion. Persisted as KEY=VALUE in
 * $XDG_CONFIG_HOME/maryui/settings.conf. The accent mapping is base.css's
 * `:root[data-accent]` block. Branding comes from /etc/os-release. */
