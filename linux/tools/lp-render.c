...
static void thread_fixtures(lp_desktop *d) {
    static const char *const LINES[] = {
        ...
        "{\"name\":\"style\",\"label\":\"Style profile\",\"description\":\"One profile per discipline: the apps that realize it and the words they answer to.\",\"id_prefix\":\"mary-style-profile-\",\"group_prefix\":\"mary-style-\",\"lane\":\"personal\",\"writer\":\"maryd\",\"fields\":[{\"name\":\"discipline\",\"type\":\"string\",\"description\":\"the craft\"}],\"graph\":\"discipline node; app practices → discipline\",\"count\":5,\"last_written_ms\":1757699900000},"
        ...
        "{\"id\":\"mary-style-mary\",\"label\":\"Style\",\"owner_id\":\"mary\",\"family\":\"style\",\"documents\":[{\"id\":\"mary-style-profile-1a2b3c4d5e6f7a8b\",\"name\":\"Writing\",\"created_at\":1757699900,\"family\":\"style\"}]},"
        ...
        "{\"id\":4410,\"at_ms\":1757700003000,\"kind\":\"search\",\"source\":\"sewnd\",\"request_id\":\"mary-turn-1757700000000-3fa2\",\"count\":2,\"ms\":41,\"detail\":\"lanes: personal\",\"documents\":[{\"rank\":1,\"document_id\":\"file-2b3c4d5e6f7a8b9c\",\"partition_id\":\"p1\",\"score\":4.21},{\"rank\":2,\"document_id\":\"1122334455667788990011\",\"partition_id\":\"p2\",\"score\":5.03}]},"
...
static int render_app(const lp_app *app, int tab, const char *path) {
    ...
    if (app == &lp_app_preview && state) {
        ...
        snprintf(picture, sizeof picture, "%s/lp-render-preview.png", tmp && *tmp ? tmp : "/tmp");
        cairo_surface_t *shot = lp_wallpaper_render(960, 600);
        cairo_surface_write_to_png(shot, picture);
        cairo_surface_destroy(shot);
        app->open(state, &d, picture);
    }
...
int main(int argc, char **argv) {
    ...
    if (strcmp(argv[1], "--all") == 0 && argc == 3) {
        ...
        snprintf(path, sizeof path, "%s/activity.png", argv[2]);
